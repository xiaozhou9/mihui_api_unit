...
import httprunner
from mihui_test_unittest_porject.test_case.test_mudole_login import TestLogin
...
if __name__ == '__main__':
    ...
    exce_path = '/Users/baiwenkai/PycharmProjects/mihuiTestProject/mihuiapi_test_unittest' \
                '/mihui_test_unittest_porject/report'
